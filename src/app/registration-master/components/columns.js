...
export const getColumns = () => {
  const columns = [
    ...
    },
    {
      ...
      width: 200,
      render: (text, record) =>
        record.registrationChamp
          ? `${record.registrationChamp.firstName || "N/A"} ${
              record.registrationChamp.lastName || "N/A"
            }`
          : "N/A",
    },
    {
    ...
    },
    {
      ...
      render: (text, record) =>
        record.primaryContact
          ? `${record.primaryContact.firstName || "N/A"} ${
              record.primaryContact.lastName || "N/A"
            }`
          : "N/A",
    },
    {
    ...
    // },
    {
      ...
      render: (_, record) => (
        <TableActions
          showUrl={`/registration-master/registration-details/${record._id}`}
        />
      ),
    },
  ];
