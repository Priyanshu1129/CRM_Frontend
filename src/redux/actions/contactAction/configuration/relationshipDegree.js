...
export const getAllRelationshipDegrees = () => async (dispatch) => {
  try {
    ...
    const data = await axiosRequest(
      ...
      `${route}/`, // URL to get all relationship degrees
      null, // No data body for GET request
      null // No query parameters for this request
    );

    console.log("get-all-relationshipDegree-res-data", data);
    dispatch(relationshipDegreeActions.getAllRelationshipDegreesSuccess(data));
  } catch (error) {
