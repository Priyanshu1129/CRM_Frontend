...
export const getSummaryView =
  ...
  async (dispatch) => {
    try {
      console.log("get-summaryView-data-req-year", year);
      ...
      console.log("get-summaryView-details-res-data", response);
      dispatch(summaryViewActions.getSummaryViewSuccess(response));
    } catch (error) {
      console.log("error", error);

      dispatch(
        summaryViewActions.getSummaryViewFailure(
          error.messaage || "An error occurred"
        )
      );
    }
  };
